...
- `GET /api/messages?visitor_id=VXXXXYYYY&after_id=0`
...
- `GET /api/messages/<id>/file?visitor_id=VXXXXYYYY`
  - Downloads attachment for a specific message id (scoped by `visitor_id`).
